...
export const dictionaries = {
  ko: {
    ...
    'feedback.close': '피드백 창 닫기',
    'feedback.category.placeholder': '유형 선택',
    'feedback.category.bug': '오류·장애 신고',
    'feedback.category.content': '콘텐츠 관련 의견',
    'feedback.category.feature': '신규 기능 제안',
    'feedback.category.ux': '사용성·화면 개선',
    'feedback.category.etc': '기타',
    'feedback.contentLabel': '피드백 내용',
    'feedback.contentPlaceholder': '자세한 내용을 적어주세요(최대 400자)',
    'feedback.characterUnit': '자',
    'feedback.submit': '제출',
    'feedback.submitting': '제출 중...',
    'feedback.success': '피드백이 제출되었습니다.',
  ...
  en: {
    ...
    'feedback.category.placeholder': 'Select a type',
    'feedback.category.bug': 'Report a bug',
    'feedback.category.content': 'Content feedback',
    'feedback.category.feature': 'Suggest a feature',
    'feedback.category.ux': 'UX and interface improvement',
    'feedback.category.etc': 'Other',
    'feedback.contentLabel': 'Feedback details',
    'feedback.contentPlaceholder': 'Tell us more (up to 400 characters)',
    'feedback.characterUnit': '',
